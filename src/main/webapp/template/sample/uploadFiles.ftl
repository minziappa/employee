...
<#include "../common/navi.ftl">
    ...
    <div class="container">
		<div class="jumbotron">
			...
			<li class="active"><a href="/employee/file/uploadFiles.do">Upload files</a></li>
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<form action="/employee/file/handleUploadFiles.do" enctype="multipart/form-data" method="POST">
